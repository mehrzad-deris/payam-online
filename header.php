    ...
    <div class="container">
        <div class="header-inner py-5 relative flex lg:justify-between justify-end-safe items-center gap-3">
            ...
            <div class="w-full lg:w-auto">
                ...
                <div id="site-mobile-menu" class="site-mobile-menu absolute top-full inset-x-0 bg-white shadow-mellow lg:hidden" data-mobile-menu hidden>
                    <?= wp_nav_menu( [
                            'theme_location' => 'main_menu',
                            'container'      => 'nav',
                            'container_aria_label' => 'فهرست اصلی موبایل',
                            'menu_class'     => 'main-menu flex flex-col gap-4 p-5',
                    ] ) ?>
                </div>
            </div>
